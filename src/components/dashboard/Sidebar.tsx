      ...
      <div className="mt-auto p-6 space-y-4">
        ...
        <div className="pt-4 border-t border-white/5">
          <div className="flex items-center gap-3 px-3 py-2">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 border border-white/10 flex items-center justify-center text-slate-950 font-black text-lg">
